...
const selectedCoursesKey = 'selectedCourses';

Template.Course_Books.onCreated(function onCreated() {
...
Template.Course_Books.helpers({

  /**
   * @returns selected Bookdata documents.
   */
  bookdataList() {
